...
var Config = {
  ...
  downloadUrl:
    'https://s3-us-west-2.amazonaws.com/dynamodb-local/dynamodb_local_2020-05-28.tar.gz',
};
...
var runningProcesses = {},
  DynamoDbLocal = {
    ...
    launch: function (
      ...
      return installDynamoDbLocal().then(function () {
        var args = [
          '-Xrs',
...
function installDynamoDbLocal() {
  ...
  if (!fs.existsSync(Config.installPath)) fs.mkdirSync(Config.installPath);
  ...
  if (fs.existsSync(Config.downloadUrl)) {
    ...
    https
      .get(Config.downloadUrl, function (redirectResponse) {
